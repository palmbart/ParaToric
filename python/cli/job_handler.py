    ...
    def __init__(self):
        ...
        self.obs_dict = [{'name': 'percolation_strength',
                        ...
                        {'name': 'sigma_x_static_susceptibility',
                         'type': 'real',
                         'output_str': r'$\langle \chi_{\sigma^x_l}^{\mathrm{stat}} \rangle$',
                         'output_func': self._real_output},
                        {'name': 'sigma_x_dynamical_susceptibility',
                         'type': 'real',
                         'output_str': r'$\langle \chi_{\sigma^x_l}^{\mathrm{dyn}} \rangle$',
                         'output_func': self._real_output},
                        {'name': 'sigma_z',
                         'type': 'real',
                        ...
                        {'name': 'sigma_z_static_susceptibility',
                         'type': 'real',
                         'output_str': r'$\langle \chi_{\sigma^z_l}^{\mathrm{stat}} \rangle$',
                         'output_func': self._real_output},
                        {'name': 'sigma_z_dynamical_susceptibility',
                         'type': 'real',
                         'output_str': r'$\langle \chi_{\sigma^z_l}^{\mathrm{dyn}} \rangle$',
                         'output_func': self._real_output},
                        {'name': 'star_x',
                         'type': 'real',
